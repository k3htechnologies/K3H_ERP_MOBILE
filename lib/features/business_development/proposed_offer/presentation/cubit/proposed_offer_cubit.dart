...
class ProposedOfferCubit extends Cubit<ProposedOfferState> {
  ...
  // ADD UPDATE HARDSHIP DETAILS
  Future<void> addUpdateHardshipDetails(
    BuildContext context, {
    required int buildingId,
    required int projectId,
    required double hardshipOfferedToResidentialAmount,
    required double hardshipOfferedToCommercialAmount,
    required String remark,
    ...
    Map<String, dynamic> body = {
      ...
      "BuildingId": buildingId,
      "ProjectId": projectId,
      "HardshipOfferedToResidentialAmount": hardshipOfferedToResidentialAmount,
      "HardshipOfferedToCommercialAmount": hardshipOfferedToCommercialAmount,
  ...
  // DELETE TAA DETAILS
  Future deleteTemporaryAlternateAccommodationDetails({
    required BuildContext context,
    required int proposedOfferTemporaryAlternateAccommodationDetailsId,
    required int projectId,
    required int buildingId,
