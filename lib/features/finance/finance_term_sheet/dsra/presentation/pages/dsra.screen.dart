...
class _DSRAScreenState extends State<DSRAScreen> {
  ...
  Future<void> _showPopupToDeeleteTermSheetDSRA(
    ...
    final result = await DialogHelper.deleteDialog(
      context,
      'You are about to delete a Term Sheet Debt Service Reserve Account ?',
      'Deleting this Term Sheet Debt Service Reserve Account will permanently remove all associated data.',
    );
