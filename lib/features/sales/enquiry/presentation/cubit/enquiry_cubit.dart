...
class EnquiryCubit extends Cubit<EnquiryState> {
  ...
  Future getEnquiryList(
    ...
    Map<String, dynamic> queryParams = {
      ...
      "Budget": state.filterBudget,
      "RequirementType": state.filterRequirementType,
      "Source": state.filterSource,
      "SubSource": state.filterSubSource,
      "ChannelPartnerMobileNumber": state.filterChannelPartnerMobile,
      "Nationality": state.filterNationality,
      "CurrentLocation": state.filterCurrentLocation,
      "CustomerClassification": state.filterCustomerClassification,
      "Ethnicity": state.filterEthnicity,
      "SalesAdvisor": state.filterSalesAdvisor,
      "SourcingManager": state.filterSourcingManager,
      "Accommodation": state.filterAccommodation,
      "EnquiryFollowUpDays": state.filterFollowUpDays,
      "FinalStage": state.filterFinalStage,

      "FromDate": state.filterStartDate?.toIso8601String(),

      "ToDate": state.filterEndDate?.toIso8601String(),
  ...
  Future<void> applyEnquiryFilterAndSort({
    ...
    required String filterRequirementType,
    required String filterSource,
    required String filterSubSource,
    required String filterChannelPartnerMobile,
    required String filterNationality,
    required String filterCurrentLocation,
    required String filterCustomerClassification,
    required String filterEthnicity,
    required String filterSalesAdvisor,
    required String filterSourcingManager,
    ...
    emit(
      state.copyWith(
        ...
        filterChannelPartnerMobile: filterChannelPartnerMobile,
        filterNationality: filterNationality,
        filterCurrentLocation: filterCurrentLocation,
        filterCustomerClassification: filterCustomerClassification,
        filterEthnicity: filterEthnicity,
        filterSalesAdvisor: filterSalesAdvisor,
        filterSourcingManager: filterSourcingManager,
