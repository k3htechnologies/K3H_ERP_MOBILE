          ...
          child: Column(
            ...
            children: [
              Expanded(
                child:
                    state.payTrackPaymentScheduleList.isEmpty
                        ? Center(child: noDataWidget(message: "No Data Found"))
                        : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isLocked =
                                paymentSchedules.bookingPaymentScheduleId <=
                                    0 ||
                                !hasDemandType;
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: List.generate(breakdownTitles.length, (
                                      ...
                                      final title =
                                          breakdownTitles[breakdownIndex];
            ...
            children: [
              Expanded(
                child: SearchWidget(
                  ...
                  textController:
                      isPaymentSchedule ? _scheduleSearchC : _ledgerSearchC,
                  ...
                  onSubmit: (value) {
                    _paymentCubit.search(
                      ...
                      bookingId: widget.bookingId,
                      projectId: widget.projectId,
                      selectedTab: isPaymentSchedule ? 0 : 1,
                    );
                  },
                ),
              ),
