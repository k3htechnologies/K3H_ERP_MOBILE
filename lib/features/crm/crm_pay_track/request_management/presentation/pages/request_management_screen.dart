        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: buildColumnTitleValueNormal(
                                          ...
                                          customValueWidget:
                                              DocumentPreviewText(
                                                text: applicant.paymentProofURL,
                                                fileUrl:
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      buildColumnTitleValueNormal(
                                        title: "Floor",
                                        value: booking.parkingData.first.floor,
                                      ),
                                    ],
                                  ),
                                  Row(
              ...
              if (booking.approvalStatus == "Cancel")
                Row(
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          _requestManagementCubit.cancelBooking(
                            ...
                            inventoryFlatId: booking.inventoryFlatId,
                            parkingId: booking.parkingId,
                          );
                        },
                        backgroundColor: AppColor.missingInformationRed
                            .withValues(alpha: 0.3),
                        textColor: AppColor.missingInformationRed,
                        leading: SvgPicture.asset(AppAssets.closeIcon),
                      ),
                    ),
                  ],
                ),
