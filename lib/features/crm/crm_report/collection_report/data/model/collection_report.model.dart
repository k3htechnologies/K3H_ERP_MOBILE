...
class CollectionReportModel {
  ...
  double registrationCompleted;
  double registrationPending;
  int bookingCount;
  ...
  factory CollectionReportModel.fromJson(Map<String, dynamic> json) =>
      CollectionReportModel(
        ...
        registrationCompleted: parseValue<double>(
          json,
          "RegistrationCompleted",
        ),
        registrationPending: parseValue<double>(json, "RegistrationPending"),
