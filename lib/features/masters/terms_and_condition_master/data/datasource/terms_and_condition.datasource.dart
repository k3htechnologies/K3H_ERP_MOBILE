...
abstract interface class TermsAndConditionDatasource {
...
class TermsAndConditionDatasourceImpl extends TermsAndConditionDatasource {
  ...
  Future<Map<String, dynamic>> apicallPullTermsAndConditionsMaster({
    ...
    try {
      ...
      return {
        'data': List<TermsAndConditionModel>.from(
          networkResponse["data"].map(
            (e) => TermsAndConditionModel.fromJson(e),
          ),
        ),
